...
const PromptResultPage = () => {
  ...
  <div className="bubble-a font-medium overflow-x-hidden overflow-y-auto">각 지방의 내일 날씨입니다. 내일은 맑은 뒤 구름이 많이 끼겠고, 제주도와 울릉도 독도에는 한두 차례 눈이 오겠습니다. 아침 최저기온은 중서부 지방이 영하 23도에서 영하 14도, 영동과 남부지방은 영하 13도에서 영하 8도로 몹시 추운 날씨가 내일 아침까지도 계속되겠습니다.
...
날씨를 전해 드렸습니다.</div>
  ...
  {/*버튼*/}
  <button type="submit" className=" bg-gpt-green text-white font-bold hover:text-black rounded-3xl text-lg py-3.5 px-20 shadow-xl">
  나가기
  </button>
  </form>
  </div></div>
